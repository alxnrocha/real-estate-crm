(function () {
  const projectName = 'InmoFlow CRM';
  const projectUrl = 'https://alxnrocha.github.io/real-estate-crm/';
  const description = 'CRM ImobiliÃ¡rio & GestÃ£o de Visitas e ImÃ³veis';
